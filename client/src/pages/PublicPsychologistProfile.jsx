      ...
      <header className="fixed top-0 w-full z-50 bg-black/10 backdrop-blur-xl border-b border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.12)]">
        <div className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto">
          ...
          <div className="flex items-center gap-2">
            <button className="text-white/70 hover:text-white transition-all duration-300 hover:bg-white/5 p-2 rounded-full scale-95 transition-transform duration-200" aria-label="Notifications">
