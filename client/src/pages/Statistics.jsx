      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow p-6 text-center">
            ...
            <p className="text-gray-500 text-sm mt-2 font-semibold">Total Sessions</p>
          </div>
          <div className="bg-white rounded-2xl shadow p-6 text-center">
            <p className="text-4xl font-bold text-purple-600">{stats?.totalPatients || 0}</p>
            <p className="text-gray-500 text-sm mt-2 font-semibold">Total Patients</p>
          </div>
          <div className="bg-white rounded-2xl shadow p-6 text-center">
            <p className="text-4xl font-bold text-yellow-500">{stats?.totalPsychologists || 0}</p>
            <p className="text-gray-500 text-sm mt-2 font-semibold">Total Psychologists</p>
          </div>
        </div>

        <div className="bg-white rounded-2xl shadow p-6 mb-6">
          <h2 className="text-lg font-bold text-gray-700 mb-4">Session Breakdown</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="font-semibold text-gray-700">Psychologists</span>
                <span className="text-gray-500">
