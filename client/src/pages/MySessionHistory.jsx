...
export default function MySessionHistory() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-[var(--app-bg)] text-[var(--app-fg)] flex items-center justify-center">
      <div className="text-sm text-[color:var(--muted)]">Loading your sessions...</div>
    </div>
  );
          ...
          {sessions.length === 0 && (
            <Glass className="p-10 text-center">
              ...
              <button
                type="button"
                onClick={() => navigate('/patient/dashboard')}
                className="mt-6 rounded-2xl bg-[color:var(--accent-90)] px-5 py-2.5 text-sm font-semibold text-white hover:brightness-110 transition"
              >
